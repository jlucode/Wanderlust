...
useEffect(() => {
    ...
    const axiosPosts = async () => {
        ...
        const response2 = await axios.get(`${'https://cors-anywhere.herokuapp.com/'}https://api.travelpayouts.com/v2/prices/latest?currency=usd&period_type=year&page=1&duration=hour&limit=5&origin=${response.data.iata}&destination=${destination}&show_to_affiliates=true&sorting=price&token=1fb2829993009e6a7db3163d4d00a1ff`)
